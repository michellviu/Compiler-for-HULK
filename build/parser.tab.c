...
static const char *const yytname[] =
{
  ...
  "PRINT", "ASSIGN", "PLUS", "MINUS", "TIMES", "DIVIDE", "SEMICOLON",
  "LPAREN", "RPAREN", "LBRACE", "RBRACE", "NUMBER", "UMINUS", "$accept",
...
{
      22,    -5,   -10,   -10,    22,   -11,    19,    22,   -11,     2,
     -10,    46,    32,    17,   -11,   -11,   -10,   -10,   -10,   -10,
     -11,    39,   -11,   -11,   -11,    -6,    -6,   -11,   -11,    22,
      23,    22,   -11
};
...
{
       0,     0,     0,     0,     0,    10,     0,     2,     3,     0,
       0,     0,     0,     0,     1,     4,     0,     0,     0,     0,
       5,     0,     6,    15,     9,    11,    12,    13,    14,     0,
       7,     0,     8
};
...
{
      15,    11,    12,     3,    18,    19,    15,     5,    10,    21,
      16,    17,    18,    19,    20,    25,    26,    27,    28,    14,
       1,     0,    30,     2,    32,     1,     0,    31,     2,    13,
       3,     0,     4,    24,     5,     3,     0,     4,     0,     5,
      16,    17,    18,    19,     0,     0,    23,    16,    17,    18,
      19,     0,     0,    29,    16,    17,    18,    19,    22
};

static const yytype_int8 yycheck[] =
{
       7,     2,     3,    13,    10,    11,    13,    17,    13,    10,
       8,     9,    10,    11,    12,    16,    17,    18,    19,     0,
       3,    -1,    29,     6,    31,     3,    -1,     4,     6,     4,
      13,    -1,    15,    16,    17,    13,    -1,    15,    -1,    17,
       8,     9,    10,    11,    -1,    -1,    14,     8,     9,    10,
      11,    -1,    -1,    14,     8,     9,    10,    11,    12
};
...
{
       0,     3,     6,    13,    15,    17,    20,    21,    22,    23,
      13,    23,    23,    21,     0,    22,     8,     9,    10,    11,
      12,    23,    12,    14,    16,    23,    23,    23,    23,    14,
      22,     4,    22
};
...
#line 40 "src/parser/parser.y"
                   { if(execute) printf("Resultado: %d\n", (yyvsp[-1].ival)); }
#line 1105 "build/parser.tab.c"
    break;

  case 6: /* stmt: PRINT expr SEMICOLON  */
#line 41 "src/parser/parser.y"
                           { if(execute) printf("Output: %d\n", (yyvsp[-1].ival)); }
#line 1111 "build/parser.tab.c"
    break;

  case 7: /* stmt: IF LPAREN expr RPAREN stmt  */
#line 42 "src/parser/parser.y"
                                 {
        int cond = (yyvsp[-2].ival);
...
#line 1145 "build/parser.tab.c"
  ...
  case 9: /* stmt: LBRACE stmt_list RBRACE  */
...
#line 74 "src/parser/parser.y"
                       { 
        if((yyvsp[0].ival) == 0) yyerror("Error: División por cero!");
